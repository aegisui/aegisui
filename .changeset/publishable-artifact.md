...
**El artefacto publicable ya es consumible desde fuera del monorepo** (ADR-024,
...
Verificado desde un consumidor externo real (proyecto fuera del monorepo, `npm
install` de los tarballs, `aegisui add` de los **siete** componentes y `tsc`
sobre los siete), y protegido por el gate required `publish-smoke` con canario
de los tres fallos.
